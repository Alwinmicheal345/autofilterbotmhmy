...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            buttons = [
                [
                    InlineKeyboardButton('Deploye', url=f'https://t.me/new_movie_HD_movies')
                ]
                ]
            ...
            buttons = [
                [
                    InlineKeyboardButton('Making Video', url=f'https://t.me/new_movie_HD_movies')
                ]
                ]
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('🖥️ How To Own 🖥️', url=f'https://t.me/new_movie_HD_movies')
                    ]
                    ]
